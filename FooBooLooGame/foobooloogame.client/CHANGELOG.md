...
- Create Angular project with ng: `ng new foobooloogame.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`foobooloogame.client.esproj`).
